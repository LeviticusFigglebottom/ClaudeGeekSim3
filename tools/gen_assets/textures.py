...
def build_catalog():
    ...
    reg("signs/ward_visiting", lambda r: sign(["VISITING HOURS", "ARE OVER"], "#e6ebe0", "#2a3a30", size=(128, 48), kind="body", font_size=16, frame_color="#6a7a6a"))
    reg("signs/ward_hours", lambda r: sign(["VISITING HOURS", "2 - 4"], "#e6ebe0", "#2a3a30", size=(128, 48), kind="body", font_size=16, frame_color="#6a7a6a"))
    reg("signs/ward_quiet", lambda r: sign(["QUIET", "PLEASE"], "#e6ebe0", "#2a3a30", size=(128, 64), kind="body", font_size=20, frame_color="#6a7a6a"))
    ...
    reg("signs/kd_shop", lambda r: sign(["THE LAST LAMP", "we sell nothing", "and we have", "plenty of it"], "#3a2416", "#f0d8a0", size=(128, 96), kind="body", font_size=15, frame_color="#8a6a3a"))
