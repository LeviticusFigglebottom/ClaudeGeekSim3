...
func _bedroom_b() -> void:
	...
	Kit.sign(self, "props/painting_house", _m(20.6, 6.53, 1.2), _yaw(180.0), Vector2(0.5, 0.5))
...
func _bedroom_corridor() -> void:
	...
	for k in 6:
		...
		Kit.sign(self, "props/painting_house", Vector3(rx + 1.2, 1.3, rf - 0.1), 0.0, Vector2(0.5, 0.5))
